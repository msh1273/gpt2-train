...
```
$ curl --request GET 'https://train-fh636v04u8tadw5erdob-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-fh636v04u8tadw5erdob-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-medium-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
