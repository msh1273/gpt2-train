...
```
$ curl --request GET 'https://train-9slf2qi6f7ee48cpsjwm-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-9slf2qi6f7ee48cpsjwm-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-medium-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
