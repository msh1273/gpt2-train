...
```
$ curl --request GET 'https://train-i9tzj0ghqtttpfkao2xs-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-i9tzj0ghqtttpfkao2xs-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-small-finetune' \
